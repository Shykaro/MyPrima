...
(function (Script) {
    ...
    function update(_event) {
        ...
        document.getElementById("--goldInput").setAttribute('value', Script.gold.toString());
        document.getElementById("--goldInputP2").setAttribute('value', Script.goldP2.toString());
